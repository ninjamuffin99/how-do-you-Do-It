...
class FlxTimer
{
    ...
    public static var manager(get, never) : TimerManager;
    ...
    /**
		 ...
		 */
    public function start(Time : Float = 1, Loops : Int = 1, Callback : Function = null) : FlxTimer
    {
    ...
    {
        return as3hx.Compat.parseInt(loops - _loopsCounter);
    }
    ...
    private static function get_manager() : TimerManager
    {
        return try cast(FlxG.getPlugin(TimerManager), TimerManager) catch(e:Dynamic) null;
    }
}
