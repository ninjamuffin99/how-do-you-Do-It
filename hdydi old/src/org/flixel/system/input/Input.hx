...
class Input
{
    ...
    /**
		 ...
		 */
    @:allow(org.flixel.system.input)
    private var _total(default, never) : Int = 256;
    ...
    {
        return Reflect.field(_map, Std.string(Reflect.field(_lookup, Key))).current == 2;
    }
    ...
    {
        return Reflect.field(_map, Std.string(Reflect.field(_lookup, Key))).current == -1;
    }
