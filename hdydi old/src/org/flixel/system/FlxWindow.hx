...
private var ImgHandle : Class<Dynamic>;
    ...
    {
        super();
        _width = as3hx.Compat.parseInt(Width);
        _height = as3hx.Compat.parseInt(Height);
        _bounds = Bounds;
        ...
        {
            maxSize = new Point(as3hx.Compat.FLOAT_MAX, as3hx.Compat.FLOAT_MAX);
        }
        _drag = new Point();
    ...
    private function onMouseMove(E : MouseEvent = null) : Void
    {
        ...
        //user is moving the window around{
