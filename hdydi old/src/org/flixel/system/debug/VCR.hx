...
private var ImgOpen : Class<Dynamic>;
    @:meta(Embed(source="../../data/vcr/record_off.png"))
private var ImgRecordOff : Class<Dynamic>;
    @:meta(Embed(source="../../data/vcr/record_on.png"))
private var ImgRecordOn : Class<Dynamic>;
    @:meta(Embed(source="../../data/vcr/stop.png"))
private var ImgStop : Class<Dynamic>;
    @:meta(Embed(source="../../data/vcr/flixel.png"))
private var ImgFlixel : Class<Dynamic>;
    @:meta(Embed(source="../../data/vcr/restart.png"))
private var ImgRestart : Class<Dynamic>;
    @:meta(Embed(source="../../data/vcr/pause.png"))
private var ImgPause : Class<Dynamic>;
    @:meta(Embed(source="../../data/vcr/play.png"))
private var ImgPlay : Class<Dynamic>;
    @:meta(Embed(source="../../data/vcr/step.png"))
private var ImgStep : Class<Dynamic>;
    
    private static var FILE_TYPES : Array<Dynamic> = [new FileFilter("Flixel Game Recording", "*.fgr")];
