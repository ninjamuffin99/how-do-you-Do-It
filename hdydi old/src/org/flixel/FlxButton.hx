...
private var ImgDefaultButton : Class<Dynamic>;
    @:meta(Embed(source="data/beep.mp3"))
private var SndBeep : Class<Dynamic>;
    ...
    /**
		 ...
		 */
    public static var PRESSED : Int = 2;
    ...
    //Figure out if the button is highlighted or pressed or what
    {
        ...
        if (FlxG.mouse.visible)
        {
            ...
            while (i < l)
            {
                camera = try cast(cameras[i++], FlxCamera) catch(e:Dynamic) null;
    ...
    /**
		 ...
		 */
    public function setSounds(SoundOver : Class<Dynamic> = null, SoundOverVolume : Float = 1.0, SoundOut : Class<Dynamic> = null, SoundOutVolume : Float = 1.0, SoundDown : Class<Dynamic> = null, SoundDownVolume : Float = 1.0, SoundUp : Class<Dynamic> = null, SoundUpVolume : Float = 1.0) : Void
    {
        if (SoundOver != null)
        {
