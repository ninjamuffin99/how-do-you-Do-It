...
private var ImgLogo : Class<Dynamic>;
    ...
    /**
		 ...
		 */
    public function new(GameSizeX : Int, GameSizeY : Int, InitialState : Class<Dynamic>, Zoom : Float = 1, GameFramerate : Int = 60, FlashFramerate : Int = 30, UseSystemCursor : Bool = false)
    {
        super();
        ...
        _mouse =new Sprite()  //basic display and update setup stuff  ;
