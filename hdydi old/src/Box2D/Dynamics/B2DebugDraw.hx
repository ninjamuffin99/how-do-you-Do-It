...
class B2DebugDraw
{
	...
	*/
    ...
    {
        m_drawFlags = m_drawFlags & as3hx.Compat.parseInt(~flags);
    }
	...
	*/
    ...
    private var m_drawScale : Float = 1.0;
    
    private var m_lineThickness : Float = 1.0;
    private var m_alpha : Float = 1.0;
    private var m_fillAlpha : Float = 1.0;
    private var m_xformScale : Float = 1.0;
}
