...
class B2GearJoint extends B2Joint
{
    ...
    public function new(def : B2GearJointDef)
    {
        ...
        {
            m_revolute1 = try cast(def.joint1, b2RevoluteJoint) catch(e:Dynamic) null;
        ...
        {
            m_prismatic1 = try cast(def.joint1, b2PrismaticJoint) catch(e:Dynamic) null;
        ...
        {
            m_revolute2 = try cast(def.joint2, b2RevoluteJoint) catch(e:Dynamic) null;
        ...
        {
            m_prismatic2 = try cast(def.joint2, b2PrismaticJoint) catch(e:Dynamic) null;
    ...
    override private function InitVelocityConstraints(step : B2TimeStep) : Void
    {
    ...
    override private function SolveVelocityConstraints(step : B2TimeStep) : Void
    //B2_NOT_USED(step);
    {
    ...
    override private function SolvePositionConstraints(baumgarte : Float) : Bool
