...
{
    //enum Type
    public static inline var e_points : Int = 0x01;
    public static inline var e_faceA : Int = 0x02;
    public static inline var e_faceB : Int = 0x04;
            ...
            proxyB : B2DistanceProxy, transformB : B2Transform) : Void
    {
        ...
        if (count == 1)
        {
            ...
            pointAY = transformA.position.y +(tMat.col1.y * tVec.x + tMat.col2.y * tVec.y)  //pointB = b2Math.b2MulX(transformB, localPointB);  ;
            
            tVec = localPointB;
            tMat = transformB.R;
            pointBX = transformB.position.x + (tMat.col1.x * tVec.x + tMat.col2.x * tVec.y);
            pointBY = transformB.position.y +(tMat.col1.y * tVec.x + tMat.col2.y * tVec.y)  //m_axis = b2Math.SubtractVV(pointB, pointA);  ;
