...
class B2PairManager
{
    ...
    public function new()
    {
        m_pairs = new Array<Dynamic>();
        m_pairBuffer = new Array<Dynamic>();
        m_pairCount = 0;
        m_pairBufferCount = 0;
        m_freePair = null;
    }
	...
	*/
    ...
    private function RemovePair(proxy1 : B2Proxy, proxy2 : B2Proxy) : Dynamic
    ...
    private var m_pairs : Array<Dynamic>;
    private var m_freePair : B2Pair;
    private var m_pairCount : Int;
    
    private var m_pairBuffer : Array<Dynamic>;
