...
class B2Shape
{
	...
	*/
    ...
    public static function TestOverlap(shape1 : B2Shape, transform1 : B2Transform, shape2 : B2Shape, transform2 : B2Transform) : Bool
    {
        ...
        return output.distance < 10.0 * as3hx.Compat.FLOAT_MIN;
    }
	...
	*/
    //enum b2ShapeType
    //{
    private static var e_unknownShape : Int = -1;
    private static inline var e_circleShape : Int = 0;
    private static inline var e_polygonShape : Int = 1;
    private static inline var e_edgeShape : Int = 2;
    private static inline var e_shapeTypeCount : Int = 3;
    //};
    ...
    public static inline var e_hitCollide : Int = 1;
    /** Return value for TestSegment indicating a miss. */
    public static inline var e_missCollide : Int = 0;
