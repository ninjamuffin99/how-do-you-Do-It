...
class B2EdgeShape extends B2Shape
{
	...
	*/
    override public function RayCast(output : B2RayCastOutput, input : B2RayCastInput, transform : B2Transform) : Bool
    {
        ...
        var k_slop : Float = 100.0 * as3hx.Compat.FLOAT_MIN;
	...
	* @private
	*/
    private function SetPrevEdge(edge : B2EdgeShape, core : B2Vec2, cornerDir : B2Vec2, convex : Bool) : Void
    {
        m_prevEdge = edge;
        m_coreV1 = core;
	...
	* @private
	*/
    private function SetNextEdge(edge : B2EdgeShape, core : B2Vec2, cornerDir : B2Vec2, convex : Bool) : Void
    {
        m_nextEdge = edge;
        m_coreV2 = core;
    ...
    private var m_v1 : B2Vec2 = new B2Vec2();
    private var m_v2 : B2Vec2 = new B2Vec2();
    
    private var m_coreV1 : B2Vec2 = new B2Vec2();
    private var m_coreV2 : B2Vec2 = new B2Vec2();
    
    private var m_length : Float;
    
    private var m_normal : B2Vec2 = new B2Vec2();
    
    private var m_direction : B2Vec2 = new B2Vec2();
    
    private var m_cornerDir1 : B2Vec2 = new B2Vec2();
    
    private var m_cornerDir2 : B2Vec2 = new B2Vec2();
    
    private var m_cornerConvex1 : Bool;
    private var m_cornerConvex2 : Bool;
    
    private var m_nextEdge : B2EdgeShape;
    private var m_prevEdge : B2EdgeShape;
}
