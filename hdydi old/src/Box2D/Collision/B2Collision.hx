...
class B2Collision
{
            ...
            poly2 : B2PolygonShape, xf2 : B2Transform) : Float
    {
        ...
        var index : Int = 0;
        var minDot : Float = as3hx.Compat.FLOAT_MAX;
        for (i in 0...count2)
    ...
    // from poly1.
    public static function FindMaxSeparation(edgeIndex : Array<Int>,
            ...
            poly2 : B2PolygonShape, xf2 : B2Transform) : Float
    {
        ...
        var edge : Int = 0;
        var maxDot : Float = -as3hx.Compat.FLOAT_MAX;
        for (i in 0...count1)
            ...
            polyB : B2PolygonShape, xfB : B2Transform) : Void
    {
        ...
        if (edge1 + 1 < count1)
        {
            local_v12 = vertices1[as3hx.Compat.parseInt(edge1 + 1)];
        }
        else
        {
            ...
            circle : B2CircleShape, xf2 : B2Transform) : Void
    {
        ...
        var separation : Float = -as3hx.Compat.FLOAT_MAX;
        ...
        if (separation < as3hx.Compat.FLOAT_MIN)
        {
            manifold.m_pointCount = 1;
            manifold.m_type = b2Manifold.e_faceA;
