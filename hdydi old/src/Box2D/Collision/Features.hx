...
class Features
{
	...
	*/
    ...
    private var _referenceEdge : Int;
	...
	*/
    ...
    {
        _incidentEdge = value;
        _m_id._key = (_m_id._key & 0xffff00ff) | (as3hx.Compat.parseInt(_incidentEdge << 8) & 0x0000ff00);
        return value;
    }
    private var _incidentEdge : Int;
	...
	*/
    ...
    private function set_incidentVertex(value : Int) : Int
    {
        ...
        _m_id._key = (_m_id._key & 0xff00ffff) | (as3hx.Compat.parseInt(_incidentVertex << 16) & 0x00ff0000);
        return value;
    }
    private var _incidentVertex : Int;
	...
	*/
    ...
    {
        _flip = value;
        _m_id._key = (_m_id._key & 0x00ffffff) | (as3hx.Compat.parseInt(_flip << 24) & 0xff000000);
        return value;
    }
    private var _flip : Int;
    
    
    private var _m_id : B2ContactID;
