...
class PhysicsDoll 
{
	...
	public function create(_world:B2World, start:FlxPoint, spriteType:Int = ATYPE):Void
	{
		...
		var fixureDef:B2FixtureDef = new B2FixtureDef();
		...
		fixureDef.shape = circ;
		fixureDef.density = 1;
		fixureDef.friction = 0.4;
		fixureDef.restitution = 0.3;
		var headY:Float = 10;
